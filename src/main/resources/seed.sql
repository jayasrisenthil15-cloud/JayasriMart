-- =============================================================================
-- JayasriMart Seed Data
-- 1 Admin, 2 Sellers, 2 Buyers, 7 Categories, 24 Products, Sample Orders & Reviews
-- =============================================================================

-- 1. Seed Users (BCrypt hashes generated with 10 log rounds)
-- Passwords:
-- admin@jayasrimart.com  -> Admin@123
-- seller1@jayasrimart.com -> Seller@123
-- seller2@jayasrimart.com -> Seller@123
-- buyer1@jayasrimart.com  -> Buyer@123
-- buyer2@jayasrimart.com  -> Buyer@123
...
-- 2. Seed Products across 7 Categories (Fashion, Electronics, Home, Beauty, Books, Food, Accessories)
...
(11, 2, '100% Pure Egyptian Cotton Bath Towel Set', 'Set of 4 plush 600 GSM combed Egyptian cotton bath towels offering exceptional softness and absorbency.', 999.00, 45, 'Home', 'https://images.unsplash.com/photo-1616046229478-9901c5536a45?w=600&auto=format&fit=crop&q=80', 4.70, TRUE, CURRENT_TIMESTAMP),
...
-- Order 1: DELIVERED (Buyer 4, total >= 999 -> delivery_charge = 0.00)
...
-- Order 2: SHIPPED (Buyer 5, subtotal 1199.00 -> free delivery)
INSERT INTO orders (id, buyer_id, total_amount, delivery_charge, status, payment_method, name, phone, address, city, pincode, created_at) VALUES
...
-- Order 3: CONFIRMED (Buyer 4, subtotal 1499.00)
INSERT INTO orders (id, buyer_id, total_amount, delivery_charge, status, payment_method, name, phone, address, city, pincode, created_at) VALUES
...
-- 5. Seed Reviews (Only eligible for DELIVERED order 1, products 1 and 6)
